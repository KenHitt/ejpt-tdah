...
export const ACADEMY_TERMS: AcademyTerm[] = [
  { term: "Host-Only", aliases: ["host-only", "vboxnet", "vboxnet0"], def: "Red virtual de VirtualBox que une el host y las VMs de esa red, sin ofrecer las víctimas a tu Wi‑Fi.", purpose: "Laboratorio aislado: Kali y la víctima se ven; Internet no es el camino del ataque.", href: "/learn/ipv4" },
  ...
  { term: "Bridged", aliases: ["bridged", "bridge"], def: "La VM aparece en la misma LAN que tu Wi‑Fi, con una IP de esa red.", purpose: "Casi nunca en este plan: pondrías una máquina diseñada para ser rota junto a la familia.", href: "/learn/ipv4" },
