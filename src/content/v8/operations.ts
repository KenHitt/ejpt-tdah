...
export interface InternalMachine {
  ...
  /** Escalera L1–L5 (V9). No sustituye difficulty textual. */
  ladder: 1 | 2 | 3 | 4 | 5;
  expectedEvidenceEs?: string;
}
...
export const V8_MACHINES: InternalMachine[] = [
  {
    ...
    estimatedMin: 25,
    ladder: 1,
    expectedEvidenceEs: "Host/ports named; no exploit claimed.",
    skillIds: ["recon", "nmap"],
  ...
  },
  {
    ...
    estimatedMin: 30,
    ladder: 2,
    expectedEvidenceEs: "Prioritized service + tool family.",
  ...
  },
  {
    ...
    estimatedMin: 30,
    ladder: 2,
    expectedEvidenceEs: "SMB users/shares plan, not Hydra SSH.",
  ...
  },
  {
    ...
    estimatedMin: 35,
    ladder: 3,
    expectedEvidenceEs: "HTTP map of THIS app, not DVWA copy.",
  ...
  },
  {
    ...
    estimatedMin: 40,
    ladder: 3,
    expectedEvidenceEs: "Hypothesis + LHOST on lab NIC + verify access.",
  ...
  },
  {
    ...
    estimatedMin: 35,
    ladder: 4,
    expectedEvidenceEs: "sudo/SUID hypothesis, not LinPEAS dump.",
  ...
  },
  {
    ...
    estimatedMin: 35,
    ladder: 4,
    expectedEvidenceEs: "whoami/priv + local enum before a named technique.",
  ...
  },
  {
    ...
    estimatedMin: 40,
    ladder: 4,
    expectedEvidenceEs: "When to pivot (Kali cannot reach the net).",
  ...
  },
  {
    ...
    estimatedMin: 50,
    ladder: 5,
    expectedEvidenceEs: "Full chain notes: recon → enum → hypothesis → (optional) exploit.",
  ...
  },
  {
    ...
    estimatedMin: 60,
    ladder: 5,
    expectedEvidenceEs: "Unknown path; decisions logged; limited hints.",
...
export const V8_BOSSES: InternalMachine[] = [
  {
    ...
    estimatedMin: 55,
    ladder: 5,
    expectedEvidenceEs: "Mixed surface without a skill checklist.",
  ...
  },
  {
    ...
    estimatedMin: 50,
    ladder: 5,
    expectedEvidenceEs: "Creds + Windows context without spoiling the technique name.",
  ...
  },
  {
    ...
    estimatedMin: 55,
    ladder: 5,
    expectedEvidenceEs: "Topology first; pivot only if Kali cannot see the host.",
