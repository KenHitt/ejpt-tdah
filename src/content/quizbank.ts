...
export const QUIZ_BANK: QuizQuestion[] = [
  ...
  {
    id: "q-wide-arp", subtopicId: "net-basic", type: "single", globalWeek: 1,
    promptEn: "ARP maps:",
    promptEs: "ARP traduce:",
    options: ["Nombre de dominio a IPv4", "IPv4 a MAC en la LAN local", "Puerto TCP a proceso", "CIDR a gateway de Internet"],
    correctAnswer: "1",
    explanationEs: "ARP es L2: IPv4 → MAC en el mismo broadcast domain. No cruza routers.",
  },
  {
    id: "q-wide-dns", subtopicId: "net-basic", type: "single", globalWeek: 2,
    promptEn: "Typical DNS port:",
    promptEs: "Puerto típico de DNS:",
    options: ["80/tcp", "53/udp (y 53/tcp para transferencias)", "445/tcp", "161/udp"],
    correctAnswer: "1",
    explanationEs: "DNS clásico en 53. SNMP es 161/udp. SMB es 445.",
  },
  {
    id: "q-wide-tools", subtopicId: "tool-selection", type: "single", globalWeek: 2,
    promptEn: "445/tcp open. First family of tools?",
    promptEs: "445/tcp open. ¿Primera familia de herramientas?",
    options: ["Gobuster", "enum4linux / smbclient / smbmap", "Hydra contra HTTP", "sqlmap a ciegas"],
    correctAnswer: "1",
    explanationEs: "445 = SMB. Gobuster es HTTP. Hydra necesita usuario y un servicio de login.",
  },
  {
    id: "q-wide-hydra", subtopicId: "hydra-bruteforce", type: "single", globalWeek: 3,
    promptEn: "Hydra against SSH with no username yet:",
    promptEs: "Hydra contra SSH sin usuario conocido:",
    options: ["Es el primer paso eJPT", "Es ruido: enumera usuarios (p. ej. SMB) antes", "Sustituye a nmap -sV", "Solo funciona con LHOST"],
    correctAnswer: "1",
    explanationEs: "Brute sin user llena logs y el reloj. Primero enum.",
  },
  {
    id: "q-wide-403", subtopicId: "gobuster-dir", type: "single", globalWeek: 3,
    promptEn: "HTTP 403 during dirbust means:",
    promptEs: "HTTP 403 en dirbust significa:",
    options: ["El path no existe", "El recurso existe pero el acceso está prohibido", "El host está caído", "Es igual que 404"],
    correctAnswer: "1",
    explanationEs: "Forbidden = existe. 404 = el servidor dice que no está.",
  },
  {
    id: "q-wide-sqli", subtopicId: "gobuster-dir", type: "single", globalWeek: 4,
    promptEn: "SQLi needs:",
    promptEs: "SQL injection necesita:",
    options: ["Solo el puerto 80 abierto", "Un parámetro/entrada que hable con una base de datos", "Siempre Metasploit", "ARP spoof"],
    correctAnswer: "1",
    explanationEs: "80 open no es SQLi. Hay que enumerar forms/params. Práctica solo en DVWA/lab.",
  },
  {
    id: "q-wide-rev", subtopicId: "reverse-vs-bind", type: "single", globalWeek: 4,
    promptEn: "In a reverse shell, who starts the TCP connection?",
    promptEs: "En una reverse shell, ¿quién inicia la conexión TCP?",
    options: ["El atacante hacia un puerto bind de la víctima", "La víctima hacia LHOST:LPORT", "El gateway de casa", "Nmap"],
    correctAnswer: "1",
    explanationEs: "Reverse = la víctima llama. Por eso LHOST debe ser alcanzable (vboxnet).",
  },
  {
    id: "q-wide-lhost", subtopicId: "msf-lhost-lport", type: "single", globalWeek: 4,
    promptEn: "LHOST for a Host-Only guest reverse shell:",
    promptEs: "LHOST para reverse hacia un guest Host-Only:",
    options: ["127.0.0.1", "La IP de Kali en vboxnet (ip addr)", "8.8.8.8", "La IP pública de tu ISP"],
    correctAnswer: "1",
    explanationEs: "El guest no ve 127.0.0.1 de Kali ni tu Wi‑Fi si solo está en Host-Only.",
  },
  {
    id: "q-wide-post", subtopicId: "msf-sysinfo", type: "single", globalWeek: 5,
    promptEn: "First post-ex check after a Linux session:",
    promptEs: "Primera comprobación post-ex tras una sesión Linux:",
    options: ["hashdump SAM", "whoami / id / uname o sysinfo", "Pivot a la Wi‑Fi de casa", "Hydra otra vez"],
    correctAnswer: "1",
    explanationEs: "Identidad y SO. SAM es Windows. Pivot solo si hay otra red del brief.",
  },
  {
    id: "q-wide-pivot", subtopicId: "full-chain", type: "single", globalWeek: 6,
    promptEn: "You pivot when:",
    promptEs: "Haces pivot cuando:",
    options: ["Acabas de terminar nmap -sn en vboxnet", "Kali no ve un segmento que sí ve un host comprometido", "Tienes 80 open", "Falló ping a 8.8.8.8"],
    correctAnswer: "1",
    explanationEs: "Pivot = puente a una red no visible desde Kali. No sustituye el recon inicial.",
  },
  {
    id: "q-wide-authz", subtopicId: "gobuster-dir", type: "single", globalWeek: 5,
    promptEn: "Authn vs authz:",
    promptEs: "Authn vs authz:",
    options: ["Son lo mismo", "Authn = quién eres; authz = qué puedes hacer", "Authz es el handshake TCP", "Authn es CIDR"],
    correctAnswer: "1",
    explanationEs: "Login ≠ permiso. IDOR/403 son a menudo authz, no 'romper el login'.",
  },
  {
    id: "q-wide-udp", subtopicId: "net-basic", type: "single", globalWeek: 2,
    promptEn: "Default TCP connect scan does not cover:",
    promptEs: "Un scan TCP por defecto no cubre:",
    options: ["22/tcp", "Servicios UDP (p. ej. SNMP 161/udp) salvo que uses -sU", "80/tcp", "445/tcp"],
    correctAnswer: "1",
    explanationEs: "Nmap TCP no lista UDP. SNMP/DNS UDP hay que pedirlos (-sU) si el brief lo sugiere.",
  },
];
